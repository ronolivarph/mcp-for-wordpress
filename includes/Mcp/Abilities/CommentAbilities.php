...
final class CommentAbilities {
	...
	public static function register_tools( ToolRegistry $r ): void {
		...
		$r->register( 'wp_comments_approve', [
		...
		$r->register( 'wp_comments_mark-spam', [
